...
public class Calculadora extends JFrame {
	...
	JPanel panelNumeros, panelOperaciones, paneltrigo;
	...
	public Calculadora() {
		super();
		setSize(250, 300);
		setTitle("Victor Eduardo Ceja Martinez      5IM9");
		...
		nuevoBotonOperacion("=");
                ...
                nuevoBotonOperacion("acos");
                 nuevoBotonOperacion("sin");
                 nuevoBotonOperacion("asin");
	...
	private void calcularResultado() {
		if (operacion.equals("+")) {
			...
			resultado *= new Double(pantalla.getText());
                ...
                }else if(operacion.equalsIgnoreCase("acos")){
